...
class KalahaGamePygame:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if self.current_player == 0:
                        ...
                        self.current_player = self.board.make_move(
                            self.players[0].name, cup
                        )
    ...
    def show_menu(self):
        while True:
            ...
            self.draw_text(
                "Kalaha", pygame.font.SysFont("Arial", 40), (255, 255, 255), 400, 100
            )
            self.draw_button(
                300, 250, 200, 50, (255, 0, 0), (200, 0, 0), "Play Game", self.play
            )
            self.draw_button(
                300, 350, 200, 50, (0, 255, 0), (0, 200, 0), "Exit", pygame.quit
            )
